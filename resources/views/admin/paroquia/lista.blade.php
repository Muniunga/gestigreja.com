...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Lista de Paroquias </h1>
                </div>

                <div class="col-sm-6" style="texte-align:right;">
                    <a href="{{url('admin/paroquia/add') }}" class="btn btn-primary">Add</a>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="card ">
                    <div class="card-header">
                        <h3 class="card-title"> Pesquisar Paroquia</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-grou col-md-3">
                                    ...
                                    <a href="{{ url('admin/paroquia/lista') }}" class="btn btn-success" type="submit" style="margin-top:30px;">concluir</a>
                                </div>
