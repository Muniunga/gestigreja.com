                        ...
                        <form method="post" action="">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Nome</label>
                                    <input type="text" class="form-control" name="name" value="{{$getRecord->name }}" placeholder="Nome completo">
                                </div>
                                <div class="form-group">
                                    <label>Genero</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$getRecord->telefone }}" name="telefone" placeholder="Telefone">
                                </div>
                                <div class="form-group">
                                    <label>Idade</label>
                                    <input type="text" class="form-control" name="idade" value="{{$getRecord->idade }}" placeholder="Idade">
                                </div>
                                <div class="form-group">
